...
public class AcceptServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>AcceptServlet</title>");
        ...
        out.println("<h1>Ты принял вызов." + "<br>" + "Поднимешься на мостик к капитану?</h1>");
        out.println("<div class=\"btn-group\" role=\"group\" aria-label=\"Basic example\">");
        out.println("<a class=\"btn btn-primary\" href= \"/go-bridge\" role=\"button\">Подняться на мостик</a>");
        out.println("<a class=\"btn btn-primary\" href= \"/refuse-get\" role=\"button\">Отказаться подниматься</a>");
        out.println("</div>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
