...
@WebServlet(name = "refuseGetServlet", value = "/refuse-get")
public class RefuseGetServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>DoneServlet</title>");
        ...
        out.println("<h2>Вы не поднялись на мостик! Нажмите на кнопку ниже чтобы начать новую игру</h2>");
        out.println("<a class=\"btn btn-primary\" href= \"/start\" role=\"button\">Начать заново</a>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
    }
